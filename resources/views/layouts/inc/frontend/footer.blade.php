            ...
            <div class="row">
                <div class="col-md-3">
                    ...
                    <p style="text-align: justify; text-justify: inter-word;">
                        {{ $appSetting->website_name ?? 'website name'}} is an online platform that allows individuals to buy and sell various reusable and
                        recyclable items. Whether you are looking to declutter your home, find a unique item, or contribute
                        to a more sustainable future, {{ $appSetting->website_name ?? 'website name'}} offers an easy and convenient solution. With a wide range of
                        categories and products, {{ $appSetting->website_name ?? 'website name'}} is a great place to find affordable and eco-friendly options. Join the
                        {{ $appSetting->website_name ?? 'website name'}} community today and start making a positive impact!
                    </p>
                </div>
                <div class="col-md-3">
                ...
                <div class="col-md-2">
                    ...
                    {{-- <div class="mb-2"><a href="{{ url('/')}}" >Trending Products</a>
                </div> --}}
...
<div class="copyright-area">
    <div class="container">
        <div class="row">
            <div class="col-md-8">
                <p class="">{{ $appSetting->website_name ?? 'website name'}} &copy; 2023 </p>
            </div>
            <div class="col-md-4">
